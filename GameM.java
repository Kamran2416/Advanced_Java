...
public class GameM implements ActionListener {
    JFrame frame = new JFrame("Pattern Quest");
    ...
    public void setUpGame(int x, Boolean what) {
        ...
        String[] b = { ":-D", "X", "O", "-(*.*)-", "<>", "<(^-^)>", "=>", ";^P",
                "ABC", "123" };// harder version
        String[] c = { "square", "circle", "rectangle", "heart", "diamond", "clover",
                "spade", "triangle", "polygon",
                "tetrahedral" };// easier version
        if (what)
    ...
    public void switchSpot(int i) {// this will switch the current spot to eitherblank or what it should have
    ...
    public void clearMain() {// clears the main menu so i can add the board orinstructions
