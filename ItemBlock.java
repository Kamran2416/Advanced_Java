...
public class ItemBlock extends Block {
    ...
    public int d; // Stores the direction of the power up. Ensures that it goes the right
    ...
    // Creates an item and adds it to the HashSet of powerups stored in PongCourt.
    // Only does this if fewer than 15 powerups exist in the HashSet.
    public void releaseItem() {
        if (PongCourt.powerUpsInPlay.size() >= 15) {
            return;
        }
