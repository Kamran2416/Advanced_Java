...
public class Goomba extends AnimatedCharacter {
    ...
    public static String goombaSprite1; // Filepaths for the sprites. Static so that they can be changed in PongCourt to
                                        // suit different levels.
    ...
    public Goomba(int x, int y, String[] urls) {
        ...
        if (PongCourt.level == 1) {
            sprites[1] = Manipulate.mirrorHorizontal(sprites[0]);
        }
