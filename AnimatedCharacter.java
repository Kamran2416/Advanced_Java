...
public abstract class AnimatedCharacter extends GameObject {
    ...
    protected int currentSprite; // Index the array is accessed by when getting the sprite to be draw on this
                                 // firing of tick()
    ...
    // Abstract method to be implemented by subclasses. This is supposed to set the
    // current sprite correctly based on the current
    // state of the player.
