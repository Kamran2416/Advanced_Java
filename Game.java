        ...
        levelObjectives.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                switch (PongCourt.level) {
                    case 1:
                        instructions += "Destroy all the Goombas to advance to the next level!";
                        break;
                    case 2:
                        instructions += "Destroy the Bloopers and avoid the Big Blooper to advance to the next level!";
                        break;
                    case 3:
                        instructions += "Avoid the nimble Pikachus and pick them off one by one to advance to the next level!";
                        break;
                    case 4:
                        instructions += "Slaughter The Great King of Evil Ganondorf's minions and crush him to advance to the next level!";
                        break;
                    case 5:
                        instructions += "Fight to the finish! Can you defeat the crazed Professor Z while fending off his minions?";
                }
